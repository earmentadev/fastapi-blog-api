...
USERS = [
    {
        "user_name": "CoreyMSchafer",
        "email": "CoreyMSchafer@gmail.com",
        "password": "TestPassword1!",
        "image": "corey.png",
    },
    {
        "user_name": "DefaultDude",
        "email": "TestEmail2@test.com",
        "password": "TestPassword2!",
        # No image - uses default
    },
    {
        "user_name": "WillowTheCat",
    ...
    {
        "user_name": "PoppyTheCoder",
        "email": "TestEmail5@test.com",
        "password": "TestPassword5!",
        "image": "poppy.png",
    },
    {
        "user_name": "GoodBoyBronx",
...
async def populate() -> None:
    ...
    async with httpx.AsyncClient(
        ...
        for user_data in USERS:
            ...
            users.append(
                {"id": user["id"], "username": user["user_name"], "token": token},
            )
